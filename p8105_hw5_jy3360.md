...
```
    ...
    ## ℹ In argument: `prop_test = list(prop.test(total_unsolved_homicides,
    ##   total_homicides))`.
...
![](p8105_hw5_jy3360_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](p8105_hw5_jy3360_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
Comment:
...
![](p8105_hw5_jy3360_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](p8105_hw5_jy3360_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->
